...
(() => {
  ...
  Object.assign(DICT.en, {
    ...
    "serv.s4.p1": "Doing your social media right means taking on a concrete job, month after month and from start to finish. We close the month's editorial calendar: what gets published, on what day and in what format. We produce the pieces —reels, carousels, stories— and write the copy in the dimensions and tone of each channel. We leave the month scheduled and, once it's live, we keep the conversation going: we reply to comments and messages within the first few hours, which is when people are paying attention. It's not posting something and looking away; it's a careful presence that supports the rest of your marketing.",
    "serv.s4.p2": "And every piece goes out with an intention, not to pad the calendar: one to get you discovered, another to make your product memorable, another to nudge people to message you. Most social media management stops at likes and followers — numbers that look good in a screenshot but don't tell you whether the business is growing. We treat social media as another traffic source: every link we publish carries its tag (UTM) and connects to your analytics, so we know which post brought visits and which of those visits converted. The pretty stuff supports the work; what counts is who you bring in.",
    ...
    "serv.s4.li1": "<strong>The month's editorial calendar.</strong> We define which channels make sense for your business (you don't need to be on all of them) and close the month's plan: what gets published, when and in what format. Every piece comes in with a reason.",
    "serv.s4.li2": "<strong>Production of assets and copy.</strong> We build the reels, the carousels and the stories, and write the copy in the dimensions and tone of each channel. Your brand looks consistent wherever you publish.",
    "serv.s4.li3": "<strong>Push stories.</strong> Beyond the feed posts, we keep the stories alive: the day-to-day format that sustains closeness and reminds people you're there between one purchase and the next.",
    "serv.s4.li4": "<strong>Conversation within the first few hours.</strong> We leave the month scheduled and handle comments and messages when they matter: within the first few hours. You validate the final publishing —social platforms penalise full automation, so the last click is human.",
    "serv.s4.li5": "<strong>Measurement from the very first link.</strong> Every link that goes out to social media carries its tag (UTM) and connects to GA4. From day one we know which post brings traffic and which traffic converts. That's what separates doing social media from decorating a profile.",
    "serv.s4.li6": "<strong>Monthly report that connects social media and business.</strong> Each month we report reach, engagement and growth, but above all the traffic that converts: which post brought visits that ended up as customers. If a channel or a format isn't contributing, we change it.",
    ...
    "serv.s5.ex_lead": "For example, here's how a welcome sequence comes together:",
    "serv.s5.ex1": "<strong>Welcome</strong>, right after they sign up: who the brand is and what whoever subscribed will get.",
    "serv.s5.ex2": "<strong>Value</strong>, a few days later: a story or a useful tip, without selling yet.",
    "serv.s5.ex3": "<strong>Nudge</strong>, a week later: the clear invitation to buy, book or order.",
  ...
  Object.assign(DICT.en, {
    ...
    "cs_men.gWeb": "Web and measurement",
    "cs_men.gWeb.sub": "The site that welcomes their people and measures every order that goes through WhatsApp.",
    ...
    "cs_men.gIG": "Instagram",
    "cs_men.gIG.sub": "How we speak to their people and bring them back to the counter.",
    "cs_men.sR.h2": "Their Instagram, in Mendieta’s voice",
    "cs_men.sR.p1": "Mendieta wanted the same thing their people are after: closeness. For their community —Argentines in Barcelona, neighbours, lifelong customers— to feel them nearby even when the order happens through a screen. So we run their Instagram end to end: we build the monthly calendar and produce the pieces —reels, carousels and stories— made for an Argentine bakery in Barcelona.",
    "cs_men.sR.p2": "Every piece comes from a real moment their people connect with. The World Cup reel, to watch the match with miga sandwiches and empanadas. The cocas for the Sant Joan revetlla, made the traditional way. A carousel explaining how to order and what delivery costs by postcode. And the day-to-day stories that keep the conversation alive between one order and the next.",
    "cs_men.sR.p3": "It’s not posting for the sake of it. Every piece has a single intention and ends by inviting the same move: ordering on WhatsApp. We reply to comments and messages within the first few hours, which is when people are warm. And it’s all said in Mendieta’s voice —Argentine, warm, with that nostalgia for the taste of home— because that closeness is the brand.",
    "cs_men.sR.p4": "And this is where the two halves meet. Because every link going out from Instagram carries its UTM, we know which post brought visits and which ones ended in a WhatsApp order. Social media and measurement aren’t two separate services: they’re the same machine —content that brings people closer, and measurement that shows what works.",
  ...
  // ---- TU WEB A MEDIDA (modelos por sector) ----
  Object.assign(DICT.en, {
    "modelos.meta.description": "Website models by sector — dental clinic, physiotherapy, yoga, construction and home renovation. See how your business website would look before commissioning it.",
    "modelos.title": "Your custom site · Vantia · Marketing Digital",
    "modelos.hero.eyebrow": "Your custom site",
    "modelos.hero.title": "See how <em>yours</em> would look.",
    ...
    "casos.grid.title": "Case studies",
    "cont.aside.title": "Before you write",
    ...
    "modelos.filter.obra": "Construction & renovation",
    "modelos.status.soon": "In progress",
    "modelos.status.live": "Available",
    "modelos.dental.name": "Dental clinic",
    "modelos.dental.sector": "Private practice · neighbourhood patients",
    "modelos.dental.inc1": "Online booking without calling, with automatic reminder",
    "modelos.dental.inc2": "Treatments explained without jargon",
    "modelos.dental.inc3": "Review request after the appointment",
    "modelos.dental.inc4": "Weekly report to management, by email",
    "modelos.fisio.name": "Physiotherapy",
    "modelos.fisio.sector": "Physiotherapy and rehabilitation centre",
    "modelos.fisio.inc1": "Session booking by service and duration",
    "modelos.fisio.inc2": "Session packs explained clearly",
    "modelos.fisio.inc3": "Profile per physiotherapist and speciality",
    "modelos.fisio.inc4": "Advance reminder to reduce no-shows",
    "modelos.yoga.name": "Yoga studio",
    "modelos.yoga.sector": "Yoga and pilates centre · classes and passes",
    "modelos.yoga.inc1": "Class timetable always up to date",
    "modelos.yoga.inc2": "Place booking with limited capacity",
    "modelos.yoga.inc3": "Passes and monthly fees with no small print",
    "modelos.yoga.inc4": "First trial class as the way in",
    "modelos.obra.name": "Construction",
    "modelos.obra.sector": "Construction company · new build and refurbishment",
    "modelos.obra.inc1": "Previous projects with technical details and photos",
    "modelos.obra.inc2": "Form that filters the enquiry before the visit",
    "modelos.obra.inc3": "Licences and certifications on display",
    "modelos.obra.inc4": "Integrated technical visit scheduling",
    "modelos.reforma.name": "Home renovation",
    "modelos.reforma.sector": "Full renovations · kitchens and bathrooms",
    "modelos.reforma.inc1": "Before and after for every renovation",
    "modelos.reforma.inc2": "Indicative estimate, without committing to a price",
    "modelos.reforma.inc3": "Timescales and work phases explained",
    "modelos.reforma.inc4": "Quote requested from the site itself",
    "modelos.cta.see": "View the model",
    "modelos.cta.want": "I want this for my business",
    "modelos.empty.text": "There is no model for that sector yet.",
    "modelos.empty.reset": "See all",
    "modelos.cta.title": "Can't see <em>your sector</em>?",
    "modelos.cta.subtitle": "Tell us what you do and what is costing you time today. We will tell you straight if we can help.",
