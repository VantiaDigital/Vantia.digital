...
(() => {
  ...
  Object.assign(DICT.en, {
    ...
    "modelos.cta.subtitle": "Tell us what you do and what is costing you time today. We will tell you straight if we can help.",
        "modelos.filter.profesional": "Professional services",
    "modelos.filter.comercio": "Retail &amp; distribution",
    "modelos.filter.transporte": "Logistics &amp; transport",
    "modelos.filter.turismo": "Tourism &amp; hospitality",
    "modelos.filter.automocion": "Automotive",
    "modelos.real.tag": "Real client",
    "modelos.cta.case": "See the case",
    "modelos.despacho.name": "Law &amp; professional practice",
    "modelos.despacho.sector": "solicitors · tax and employment advisers · property managers",
    "modelos.distribucion.name": "Wholesale &amp; B2B ordering",
    "modelos.distribucion.sector": "food and drink wholesalers · printers and graphic arts",
    "modelos.logistica.name": "Logistics &amp; transport",
    "modelos.logistica.sector": "logistics operators · freight · courier services",
    "modelos.inmobiliaria.name": "Estate agency",
    "modelos.inmobiliaria.sector": "sales · lettings · new developments",
    "modelos.turismo.name": "Tourism &amp; accommodation",
    "modelos.turismo.sector": "small hotels · guesthouses · holiday flats · rural houses",
    "modelos.automocion.name": "Automotive",
    "modelos.automocion.sector": "garages · bodywork and paint · tyres · MOT prep",
    "modelos.formacion.name": "Training &amp; academies",
    "modelos.formacion.sector": "languages · tutoring · vocational training · driving schools",
    "modelos.tienda.name": "Online shop",
    "modelos.tienda.sector": "retail selling and taking payment on the site itself",
        "modelos.construccion.name": "Construction &amp; building",
    "modelos.construccion.sector": "contractors · developers · architecture and engineering · refurbishment",
    "modelos.construccion.inc1": "Every job with its spec sheet and its deadline",
    "modelos.construccion.inc2": "The six phases, with who answers at each one",
    "modelos.construccion.inc3": "Quote request with the details that actually matter",
    "modelos.construccion.inc4": "What can honestly be promised, in writing",
    "modelos.reformas.name": "Home renovation &amp; trades",
    "modelos.reformas.sector": "full refurbishments · plumbing · electrics · heating and cooling",
    "modelos.reformas.inc1": "A price range in ten seconds",
    "modelos.reformas.inc2": "Works calendar signed before anything starts",
    "modelos.reformas.inc3": "The new layout, before the first wall comes down",
    "modelos.reformas.inc4": "Jobs told by what was decided, not by the pretty photo",
    "modelos.despacho.inc1": "Guidance by situation: practice area, cost and legal deadline",
    "modelos.despacho.inc2": "Fees by billing model, and which costs the firm does not charge",
    "modelos.despacho.inc3": "Team with verifiable bar registration numbers",
    "modelos.despacho.inc4": "A section of its own for residents' associations",
    "modelos.distribucion.inc1": "Product list with pack size and sales unit",
    "modelos.distribucion.inc2": "Ordering on account, no checkout",
    "modelos.distribucion.inc3": "Delivery areas, days and order cut-off times",
    "modelos.distribucion.inc4": "Account opening with the business's tax details",
    "modelos.logistica.inc1": "Transit time by route, origin and destination",
    "modelos.logistica.inc2": "Coverage map and cut-off times",
    "modelos.logistica.inc3": "Shipment tracking by consignment number",
    "modelos.logistica.inc4": "Quotes with weight, dimensions and load type",
    "modelos.inmobiliaria.inc1": "Search with filters for area, price and floor area",
    "modelos.inmobiliaria.inc2": "Listing with gallery, floor plan and energy certificate",
    "modelos.inmobiliaria.inc3": "A separate path for the owner who is selling",
    "modelos.inmobiliaria.inc4": "Property valuation request",
    "modelos.turismo.inc1": "Availability calendar with price per night",
    "modelos.turismo.inc2": "Direct booking, no portal commission",
    "modelos.turismo.inc3": "Room types with their own gallery",
    "modelos.turismo.inc4": "What is nearby, to sell the whole stay",
    "modelos.automocion.inc1": "Booking that asks for make, model and registration",
    "modelos.automocion.inc2": "Quote approved before anything is touched",
    "modelos.automocion.inc3": "Guide prices by service",
    "modelos.automocion.inc4": "What to do with the keys outside opening hours",
    "modelos.formacion.inc1": "Full weekly timetable, not a PDF",
    "modelos.formacion.inc2": "Intakes with dates, places and status",
    "modelos.formacion.inc3": "Level test that recommends a course",
    "modelos.formacion.inc4": "Online enrolment, with guardian details for minors",
    "modelos.tienda.inc1": "Catalogue with filters and stock on show",
    "modelos.tienda.inc2": "Product page with size, colour and format variants",
    "modelos.tienda.inc3": "Cart and full checkout",
    "modelos.tienda.inc4": "Shipping, returns and order tracking",
    "modelos.caso_mendieta.sector": "food retail with ordering and tracking · imported products",
    "modelos.caso_mendieta.text": "Argentine food shop in Spain. Catalogue, ordering and tracking.",
    "modelos.caso_parrilleros.sector": "events and catering · service at your address",
    "modelos.caso_parrilleros.text": "Argentine barbecue at home and for events, with booking and quotes.",
    "modelos.caso_gett.sector": "bespoke furniture and joinery · interiors",
    "modelos.caso_gett.text": "Bespoke joinery, with the project told piece by piece.",
    "modelos.caso_lulitas.sector": "catalogue without a shop · made to order",
    "modelos.caso_lulitas.text": "A catalogue that shows the product and closes the sale by message.",
    "modelos.caso_salamat.sector": "restaurant · menu and booking",
