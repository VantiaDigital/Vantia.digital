...
# Copy mejorado por el Copywriter. fondo en damero para grid 3x3 (impares oscuro).
PIECES = [
    dict(n=1, slug="feed-01-no-se-mide", kind="quote", dark=True, eyebrow="TESIS VANTIA",
         lines=["Lo que no", "se mide", "se adivina."], accent="adivina"),
    dict(n=2, slug="feed-02-hablamos-al-dueno", kind="title", dark=False, eyebrow="PARA QUIÉN TRABAJAMOS",
         title="No le hablamos a tu equipo de marketing. Te hablamos a ti.",
         body=["La mayoría de agencias dan por hecho que tienes un departamento que les traduzca. Tú no lo tienes.",
               "No necesitas jerga. Necesitas saber qué pasa con tu dinero y qué decisión tomar el lunes."]),
    dict(n=3, slug="feed-03-web-bien-hecha", kind="check", dark=True, eyebrow="ANTES DE PAGAR UNA WEB",
         title="Una web bien hecha tiene",
         items=["Medición lista desde el día uno", "Una acción clara que quieres que pase",
                "Velocidad de carga real, no de demo", "Una forma de saber si funciona"]),
    dict(n=4, slug="feed-04-visita-no-es-cliente", kind="quote", dark=False, eyebrow="LO QUE MIDES IMPORTA",
         lines=["Una visita", "no paga", "facturas."], accent="paga"),
    dict(n=5, slug="feed-05-medir-antes", kind="title", dark=True, eyebrow="CÓMO TRABAJAMOS",
         title="Medimos antes de ejecutar. Siempre.",
         body=["Nadie invierte a ciegas con su propio dinero. Tu marketing no debería ser la excepción.",
               "Primero dejamos la medición lista. Después movemos una cosa. Así sabes qué la movió."]),
    dict(n=6, slug="feed-06-no-es-folleto", kind="title", dark=False, eyebrow="OPINIÓN",
         title="Tu web no es un folleto. Es tu mejor comercial.",
         body=["Un folleto se mira y se tira. Un comercial atiende, responde y cierra a cualquier hora.",
               "Si tu web no hace eso, no es que sea cara. Es que es un gasto que no te devuelve nada."]),
    dict(n=7, slug="feed-07-medir-de-verdad", kind="check", dark=True, eyebrow="MEDIR DE VERDAD ES",
         title="Saber esto de tu web",
         items=["De dónde llega cada cliente", "Qué página los hace irse",
                "Cuántos terminan en contacto", "Cuánto te cuesta conseguir uno"]),
    dict(n=8, slug="feed-08-primero-medir", kind="quote", dark=False, eyebrow="EL ORDEN CORRECTO",
         lines=["Primero", "medir.", "Luego", "invertir."], accent="medir"),
    dict(n=9, slug="feed-09-portfolio-honesto", kind="title", dark=True, eyebrow="SIN PROMESAS VACÍAS",
         title="No te prometemos números. Te los enseñamos.",
         body=["Cualquiera promete duplicarte las ventas en una llamada de diez minutos. Nadie firma esa cifra.",
               "Nosotros dejamos la medición lista y te enseñamos qué pasó de verdad. Datos antes que promesas."]),
]
